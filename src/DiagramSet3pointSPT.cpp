...
: DiagramSetBase(order), _kerneltypes(kerneltypes)
{
   ...
   // B211
   // propagators
   Propagator prop_B211_k2(LabelMap<Momentum, Propagator::LabelFlow> {{Momentum::k2, Propagator::LabelFlow::Plus}});
   Propagator prop_B211_k3(LabelMap<Momentum, Propagator::LabelFlow> {{Momentum::k3, Propagator::LabelFlow::Plus}});
   // lines
   ...
   if (_order == Order::OneLoop) {
      // B411
      // propagators
      Propagator prop_B411_q(LabelMap<Momentum, Propagator::LabelFlow> {{Momentum::q, Propagator::LabelFlow::Plus}});
      Propagator prop_B411_k2(LabelMap<Momentum, Propagator::LabelFlow> {{Momentum::k2, Propagator::LabelFlow::Plus}});
      Propagator prop_B411_k3(LabelMap<Momentum, Propagator::LabelFlow> {{Momentum::k3, Propagator::LabelFlow::Plus}});
      // lines
      ...
      // B321a
      // propagators
      Propagator prop_B321a_q(LabelMap<Momentum, Propagator::LabelFlow> {{Momentum::q, Propagator::LabelFlow::Plus}});
      Propagator prop_B321a_k23(LabelMap<Momentum, Propagator::LabelFlow> {{Momentum::k2, Propagator::LabelFlow::Plus}, {Momentum::k3, Propagator::LabelFlow::Plus}});
      Propagator prop_B321a_k3(LabelMap<Momentum, Propagator::LabelFlow> {{Momentum::k3, Propagator::LabelFlow::Plus}});
      // lines
      ...
      // B321b
      // propagators
      Propagator prop_B321b_q(LabelMap<Momentum, Propagator::LabelFlow> {{Momentum::q, Propagator::LabelFlow::Plus}});
      Propagator prop_B321b_qk2(LabelMap<Momentum, Propagator::LabelFlow> {{Momentum::q, Propagator::LabelFlow::Minus}, {Momentum::k2, Propagator::LabelFlow::Plus}});
      Propagator prop_B321b_k3(LabelMap<Momentum, Propagator::LabelFlow> {{Momentum::k3, Propagator::LabelFlow::Plus}});
      // lines
      ...
      // B222
      // propagators
      Propagator prop_B222_q(LabelMap<Momentum, Propagator::LabelFlow> {{Momentum::q, Propagator::LabelFlow::Plus}});
      Propagator prop_B222_qk2(LabelMap<Momentum, Propagator::LabelFlow> {{Momentum::q, Propagator::LabelFlow::Plus}, {Momentum::k2, Propagator::LabelFlow::Minus}});
      Propagator prop_B222_qk23(LabelMap<Momentum, Propagator::LabelFlow> {{Momentum::q, Propagator::LabelFlow::Minus}, {Momentum::k2, Propagator::LabelFlow::Plus}, {Momentum::k3, Propagator::LabelFlow::Plus}});
      // lines

...
PowerSpectrum::PowerSpectrum(Order order, LinearPowerSpectrumBase* PL) : _order(order), _PL(PL), _SPTkernels(new SPTkernels)
{
   ...
   // define the diagram
   Diagram P11(lines_P11, kernels_SPT, _PL);
   ...
   if (_order == kOneLoop) {
      ...
      // define the diagram
      Diagram P31(lines_P31, kernels_SPT, _PL);

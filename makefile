...
test: test.o ThreeVector.o SPTkernels.o EFTkernels.o DiagramBase.o DiagramTree.o DiagramOneLoop.o DiagramTwoLoop.o DiagramSet2point.o Random.o Labels.o MomentumMap.o VertexMap.o Propagator.o LinearPowerSpectrumCAMB.o PowerSpectrum.o
	mkdir -p bin
